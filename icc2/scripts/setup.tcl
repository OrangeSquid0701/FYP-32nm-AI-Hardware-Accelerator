set NDM_PATH "/data/synopsys/lib/saed14nm/lib"

set REF_LIBS " \
  $NDM_PATH/stdcell_lvt/ndm/saed14lvt_frame_only.ndm \
  $NDM_PATH/stdcell_rvt/ndm/saed14rvt_frame_only.ndm \
  $NDM_PATH/stdcell_hvt/ndm/saed14hvt_frame_only.ndm \
  $NDM_PATH/stdcell_hvt/ndm/tech_ndm/1p9m_tech.ndm \
"

create_lib ACCEL_LIB \
  -technology /data/synopsys/lib/saed14nm/lib/tech/milkyway/tfs/saed14nm_1p9m_mw_v1.tf \
  -ref_libs $REF_LIBS
